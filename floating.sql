...
Source Database       : floating

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2022-05-06 14:44:09
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `floating_area`
-- ----------------------------
DROP TABLE IF EXISTS `floating_area`;
CREATE TABLE `floating_area` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `pid` bigint(20) DEFAULT NULL COMMENT '省id',
  `cid` bigint(20) DEFAULT NULL COMMENT '市id',
  `aid` bigint(20) DEFAULT NULL COMMENT '区id',
  `state` varchar(2) DEFAULT '0' COMMENT '状态0-低风险，1-中风险，2-高风险',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `remove_time` datetime DEFAULT NULL COMMENT '解除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of floating_area
-- ----------------------------
INSERT INTO `floating_area` VALUES ('2', '2', '343', '20', '2', '2022-05-05 16:27:08', '2022-05-05 16:50:10');

-- ----------------------------
-- Table structure for `floating_person`
-- ----------------------------
DROP TABLE IF EXISTS `floating_person`;
CREATE TABLE `floating_person` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `pid` bigint(20) DEFAULT NULL COMMENT '省ID',
  `cid` bigint(20) DEFAULT NULL COMMENT '城市id',
  `aid` bigint(20) DEFAULT NULL COMMENT '区id',
  `state` varchar(2) DEFAULT '0' COMMENT '风险状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of floating_person
-- ----------------------------
INSERT INTO `floating_person` VALUES ('1', '1', '李先生', '110101199001015418', '13212341234', '36.5', '1', '1', '1', '1', '2022-05-04 20:52:02');
INSERT INTO `floating_person` VALUES ('2', '1', '王某人', '110101123123', '13312341234', '36.5', '3', '3', '61', '0', '2022-05-05 17:13:03');
INSERT INTO `floating_person` VALUES ('3', '1', '十大高', '123123', '155123123', '37.0', '2', '343', '20', '2', '2022-05-05 17:27:07');
INSERT INTO `floating_person` VALUES ('4', '2', '刘萌萌', '235235235', '1212515', '36.5', '8', '60', '661', '0', '2022-05-05 17:44:23');

-- ----------------------------
-- Table structure for `floating_risk_person`
-- ----------------------------
DROP TABLE IF EXISTS `floating_risk_person`;
CREATE TABLE `floating_risk_person` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) DEFAULT NULL COMMENT '操作人',
  `name` varchar(32) DEFAULT NULL COMMENT '姓名',
  `idcard` varchar(32) DEFAULT '' COMMENT '证件号码',
...
-- ----------------------------
-- Records of floating_risk_person
-- ----------------------------
...
CREATE TABLE `sys_area` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '省ID',
  `code` varchar(6) DEFAULT NULL COMMENT '地区码',
  `name` varchar(20) DEFAULT NULL COMMENT '省',
  `city_code` varchar(20) DEFAULT NULL COMMENT '省',
  PRIMARY KEY (`id`)
...
INSERT INTO `sys_city` VALUES ('72', '310100', '市辖区', '310000');
INSERT INTO `sys_city` VALUES ('73', '310200', '县', '310000');
...
CREATE TABLE `sys_dict` (
  ...
  `val` varchar(7) DEFAULT NULL COMMENT '键值',
  `label` varchar(64) DEFAULT NULL,
  `describe` varchar(10) DEFAULT NULL COMMENT '描述',
  `sort` int(3) DEFAULT NULL COMMENT '序号',
  `parent_id` bigint(20) DEFAULT 0 COMMENT '父节点id',
  `state` char(2) DEFAULT '1' COMMENT '状态0-禁用,1-启用',
  PRIMARY KEY (`id`),
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES ('1', 'state', '1', '启用', '状态', '1', '0', '1');
INSERT INTO `sys_dict` VALUES ('2', 'state', '0', '禁用', '状态', '2', '0', '1');
INSERT INTO `sys_dict` VALUES ('3', 'sex', '男', '男', '性别', '1', '0', '1');
INSERT INTO `sys_dict` VALUES ('4', 'sex', '女', '女', '性别', '2', '0', '1');
INSERT INTO `sys_dict` VALUES ('5', 'risk_state', '0', '低风险', '风险状态', '1', '0', '1');
INSERT INTO `sys_dict` VALUES ('6', 'risk_state', '1', '中风险', '风险状态', '2', '0', '1');
INSERT INTO `sys_dict` VALUES ('7', 'risk_state', '2', '高风险', '风险状态', '3', '0', '1');
...
CREATE TABLE `sys_menus` (
  ...
  `has_son` int(2) DEFAULT NULL COMMENT '是否具有子节点',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `sys_menus` VALUES ('1', '首页', '/html/home/list.html', '1', null, '0');
INSERT INTO `sys_menus` VALUES ('2', '系统设置', '#', '2', null, '1');
INSERT INTO `sys_menus` VALUES ('3', '参数设置', '/html/sys/list.html', '2', '2', '0');
INSERT INTO `sys_menus` VALUES ('4', '系统维护', '#', '3', null, '1');
INSERT INTO `sys_menus` VALUES ('5', '角色管理', '/html/role/list.html', '1', '4', '0');
INSERT INTO `sys_menus` VALUES ('6', '用户管理', '/html/user/list.html', '2', '4', '0');
INSERT INTO `sys_menus` VALUES ('7', '个人中心', '#', '4', null, '1');
INSERT INTO `sys_menus` VALUES ('8', '个人信息', '/html/person/list.html', '4', '7', '0');
INSERT INTO `sys_menus` VALUES ('9', '风险地区管理', '/html/riskarea/list.html', '5', null, '0');
INSERT INTO `sys_menus` VALUES ('10', '风险人员管理', '/html/riskpeople/list.html', '6', null, '0');
INSERT INTO `sys_menus` VALUES ('11', '流动人口登记', '/html/population/list.html', '7', null, '0');
...
CREATE TABLE `sys_role` (
  ...
  `role_value` varchar(10) DEFAULT NULL COMMENT '角色值',
  PRIMARY KEY (`id`)
...
INSERT INTO `sys_role` VALUES ('2', '市级管理层', 'manager');
INSERT INTO `sys_role` VALUES ('3', '基层负责人', 'user');
...
CREATE TABLE `sys_role_permission` (
  ...
  `power` varchar(255) DEFAULT NULL COMMENT '功能权限',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `sys_role_permission` VALUES ('1', '1', '1', 'all');
INSERT INTO `sys_role_permission` VALUES ('2', '1', '2', 'all');
INSERT INTO `sys_role_permission` VALUES ('3', '1', '3', 'all');
INSERT INTO `sys_role_permission` VALUES ('4', '1', '4', 'all');
INSERT INTO `sys_role_permission` VALUES ('5', '1', '5', 'all');
INSERT INTO `sys_role_permission` VALUES ('6', '1', '6', 'all');
INSERT INTO `sys_role_permission` VALUES ('7', '1', '7', 'all');
INSERT INTO `sys_role_permission` VALUES ('8', '1', '8', 'all');
INSERT INTO `sys_role_permission` VALUES ('9', '1', '9', 'all');
INSERT INTO `sys_role_permission` VALUES ('10', '1', '10', 'all');
INSERT INTO `sys_role_permission` VALUES ('11', '1', '11', 'all');
INSERT INTO `sys_role_permission` VALUES ('15', '2', '7', 'all');
INSERT INTO `sys_role_permission` VALUES ('16', '2', '1', 'all');
INSERT INTO `sys_role_permission` VALUES ('17', '2', '8', 'all');
INSERT INTO `sys_role_permission` VALUES ('18', '2', '9', 'all');
INSERT INTO `sys_role_permission` VALUES ('20', '2', '11', 'all');
INSERT INTO `sys_role_permission` VALUES ('21', '3', '7', 'all');
INSERT INTO `sys_role_permission` VALUES ('22', '3', '1', 'all');
INSERT INTO `sys_role_permission` VALUES ('23', '3', '8', 'all');
INSERT INTO `sys_role_permission` VALUES ('24', '3', '9', 'query');
INSERT INTO `sys_role_permission` VALUES ('25', '2', '10', 'all');
INSERT INTO `sys_role_permission` VALUES ('26', '3', '11', 'all');
...
CREATE TABLE `sys_user` (
  ...
  `name` varchar(10) DEFAULT NULL COMMENT '姓名（昵称）',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '管理员', 'admin', '181dc9bdb52d04dc20036dbd8313ed055', '1');
INSERT INTO `sys_user` VALUES ('2', '社区负责人', 'user', '1e10adc3949ba59abbe56e057f20f883e', '3');
INSERT INTO `sys_user` VALUES ('3', '王秘书', 'manage', '1e10adc3949ba59abbe56e057f20f883e', '2');
